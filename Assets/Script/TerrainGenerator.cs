...
public class TerrainGenerator: MonoBehaviour {
	[Header( "Templates" )]
	public List<TerrainController> terrainTemplates;
	public float terrainTemplateWidth;

	[Header( "Force Early Template" )]
	public List<TerrainController> earlyTerrainTemplates;
	...
	private void Start() {
		...
		foreach(TerrainController terrain in earlyTerrainTemplates) {
	...
	private void GenerateTerrain(float posX, TerrainController forceTerrain = null) {
